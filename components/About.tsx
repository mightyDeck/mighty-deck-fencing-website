      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-lg text-primaryBlack/80 leading-relaxed">
               For years, Mighty Fences in Columbia has been the area's premier choice for quality fence installation and service. Our commitment to excellence, combined with superior craftsmanship and premium materials, has earned us the trust of hundreds of satisfied customers throughout the surrounding areas.
              </p>

              <p className="text-lg text-primaryBlack/80 leading-relaxed">
                We understand the unique needs of our community. From protecting your family's privacy to securing your commercial property, we deliver solutions that combine functionality with lasting beauty.
              </p>
            </div>
        ...
        {/* Mission Statement */}
          {/* <div className="mt-20 text-center max-w-4xl mx-auto animate-fade-in">
            <div className="bg-white border border-black/20 rounded-2xl p-8 md:p-12">
              <Award className="w-12 h-12 text-primaryYellow mx-auto mb-6" />
        ...
        <div className="mt-20 text-center max-w-4xl mx-auto animate-fade-in">
  <div className="bg-white border border-black/20 rounded-2xl p-8 md:p-12 shadow-lg">
    <Award className="w-12 h-12 text-primaryYellow mx-auto mb-6" />
    <h3 className="text-2xl md:text-3xl font-bold text-primaryBlack mb-6">
      Our Mission
    </h3>
    ...
    <div className="mt-6 text-sm text-primaryBlack/70 font-medium">
      — The Mighty Fences Columbia Team
    </div>
  </div>
</div>
