        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight">
                Professional <span className="bg-primaryRed bg-clip-text text-transparent">Fence Installation</span> You Can Trust
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/contact">
                <Button
                  size="lg"
                  className="border-2 border-primaryRed bg-primaryRed text-white hover:bg-primaryRed/90 hover:text-white text-lg px-8 py-6"
                >
                  Get Free Estimate
                </Button>
              </Link>
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-primaryRed text-primaryRed hover:bg-primaryRed hover:text-white text-lg px-8 py-6"
                asChild
              >
          ...
          <div className="relative animate-slide-in-right">
            <div className="relative rounded-2xl overflow-hidden elegant-shadow">
              <div className="absolute inset-0 bg-gradient-to-t from-primaryRed/20 to-transparent"></div>
