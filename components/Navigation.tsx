...
export const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white z-50 smooth-transition">
    {/* <nav className="fixed top-0 w-full bg-red-100/95 backdrop-blur-md border-b border-blue-300 z-50 smooth-transition"> */}
        ...
        <div className="flex items-center justify-between h-16">
            ...
            <Link
              ...
              className={`smooth-transition ${
                location === "/services"
                  ...
                  : "text-foreground hover:text-primaryRed"
              }`}
            >
              Services
            </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link href="/contact">
              <Button
                variant="default"
                className="border-2 border-primaryRed text-white bg-primaryRed hover:bg-primaryRed/90 hover:text-white smooth-transition"
              >
                Free Estimate
              </Button>
            </Link>
